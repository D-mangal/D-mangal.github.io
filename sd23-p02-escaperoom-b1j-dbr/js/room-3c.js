...
monitor.addEventListener("click", function () {
  monitor = alert(
    "WOW JE WIST HET ANTWOORD. ZO SLIM BEN JE!!! Maar we zijn nog niet klaar. Voor de volgende puzzle heb je een code nodig. Maar geen zorgen ik zal je de cijfers geven: 3604."
  );
});
...
staff2.addEventListener("click", function () {
  staff2 = alert(
    "D. Nunes moet op maandag werken. Hij betaalt ons €3.50 per uur"
  );
});
